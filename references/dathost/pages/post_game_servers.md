...
```json
{
  ...
  "paths": {
    "/api/0.1/game-servers": {
      "post": {
        "description": "On success this returns the new server in the same format as game-servers.",
        "operationId": "post_game_servers",
        "requestBody": {
          "content": {
            "multipart/form-data": {
              "schema": {
                ...
                "properties": {
                  ...
                  "cs2_settings.workshop_collection_id": {
